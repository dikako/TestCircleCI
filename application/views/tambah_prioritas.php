...
<body>
	...
	<section role="main" class="content-body">
					...
					<div class="row">
						<div class="col-lg-12">
							<form id="form" action="<?php base_url('c_prioritas/add') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Form Input Prioritas</h2>
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-9">
												...
												<input <?php echo form_error('nama_prioritas') ? 'is-invalid':'' ?> type="text" name="nama_prioritas" class="form-control" placeholder="eg.: Mayor, etc" value="<?php echo set_value('nama_prioritas'); ?>" required/>
											</div>
										</div>
