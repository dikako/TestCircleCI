...
<body>
	...
	<section role="main" class="content-body">
					...
					<div class="row">
						<div class="col-lg-12">
							<form id="form" action="<?php echo base_url('c_member/update_member') ?>" method="POST" class="form-horizontal">
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-9">
												...
												<input <?php echo form_error('nama_member') ? 'is-invalid':'' ?> type="text" name="nama_member" class="form-control" placeholder="eg.: John Doe" value="<?php echo $member->nama_member; ?>" required/>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<div class="input-group">
													...
													<input type="email" name="email" class="form-control" placeholder="eg.: email@email.com" value="<?php echo $member->email; ?>" required/>
												</div>
											</div>
										</div>
										...
										<div class="form-group">
											<label class="col-md-3 control-label">Deskripsi</label>
												<div class="col-sm-9">
													...
													<input <?php //echo form_error('deskripsi') ? 'is-invalid':'' ?> class="form-control" name="deskripsi" value="<?php echo $member->deskripsi; ?>" />
												</div>
										</div>
