					...
					<div class="row">
						<div class="col-lg-12">
							<form id="form" action="<?php base_url('c_tipenote/add') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
								<input type="hidden" name="id" value="<?php echo $tipe_note->id_tipe_note?>;" />
								<section class="panel">
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-9">
												...
												<input <?php echo form_error('nama_tipe_note') ? 'is-invalid':'' ?> type="text" name="nama_tipe_note" class="form-control" placeholder="eg.: Mayor, etc" value="<?php echo $tipe_note->nama_tipe_note; ?>" required/>
											</div>
										</div>
