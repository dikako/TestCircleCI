...
<body>
	...
	<section role="main" class="content-body">
					...
					<div class="row">
						<div class="col-lg-12">
							<form id="form" action="<?php echo base_url('c_kategori/update_data'); ?>" method="post" class="form-horizontal">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Form Edit Kategori</h2>
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="nama_kategori" class="form-control" placeholder="eg.: Web, Android, etc" value="<?php echo $record->nama_kategori; ?>" required/>
											</div>
										</div>
